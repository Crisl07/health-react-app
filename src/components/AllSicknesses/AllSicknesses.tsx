...
import TextField from '@material-ui/core/TextField'; import LocalHospital from "@material-ui/icons/LocalHospital";
    ...
    <React.Fragment>
      ...
      <main>
        ...
        <Container className={classes.cardGrid} maxWidth="lg">
          <Button onClick={() => history.push("/sicknesses")} className={classes.addbutton} size="medium" color="secondary">
            Go to your sicknesses
          </Button>
          <Button onClick={() => history.push("/createSickness")} className={classes.addbutton} size="medium" color="secondary">
